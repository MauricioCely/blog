...
[A post]({{< ref "/post/writing-technical-content/index.md" >}})

{{% staticref "img/icon_original.png" "newtab" %}}Download my CV{{% /staticref %}}
...
To mention someone, type {{% mention "admin" %}}
...
{{< figure library="true" src="icon_original.png" title="A caption" lightbox="true" >}}
...
{{< figure src="featured.jpg" title="A caption" numbered="true" lightbox="true" >}}
